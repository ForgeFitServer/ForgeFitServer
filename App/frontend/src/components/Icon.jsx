const P = {
  ...
  // Iron forge anvil: wide top plate, waist, wide base, sharp horn on left
  forge: <><path d="M4 9H20V14H17V18H19V21H5V18H7V14H4" /><path d="M4 10L0.8 11L4 13" /></>,
  ...
  camera: <><path d="M4.4 8.4h3l1.4-2.2h6.4L16.6 8.4h3a1.6 1.6 0 0 1 1.6 1.6v7.4a1.6 1.6 0 0 1-1.6 1.6H4.4a1.6 1.6 0 0 1-1.6-1.6V10a1.6 1.6 0 0 1 1.6-1.6Z" /><circle cx="12" cy="13.6" r="3.2" /></>,
  ruler: <><rect x="3.4" y="8.2" width="17.2" height="7.6" rx="1.4" transform="rotate(0 12 12)" /><path d="M7.2 8.2v3M10.4 8.2v4M13.6 8.2v3M16.8 8.2v4" /></>,
