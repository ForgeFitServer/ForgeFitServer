...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": '此浏览器不支持通行密钥——你仍可上本设备上本地使用 Forge Fitness Server。',
  ...
  'to install ForgeFitServer as a full-screen app.': '即可将 ForgeFitServer 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': '休息计时提醒，即使 ForgeFitServer 已关闭。',
