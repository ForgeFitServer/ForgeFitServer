...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": 'Bu tarayıcı geçiş anhtarlarını desteklemiyor — yine de Forge Fitness Server\'i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install ForgeFitServer as a full-screen app.': 'ile ForgeFitServer’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': 'ForgeFitServer kapalıyken bile dinlenme sayacı uyarıları.',
