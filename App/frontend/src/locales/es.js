export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": 'Este navegador no admite passkeys — aún así puedes usar Forge Fitness Server localmente en este dispositivo.',
  ...
  'to install Forge Fitness Server as a full-screen app.': 'para instalar Forge Fitness Server como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if Forge Fitness Server is closed.': 'Avisos del temporizador de descanso, incluso con Forge Fitness Server cerrado.',
