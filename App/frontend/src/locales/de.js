export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst Forge Fitness Server trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install Forge Fitness Server as a full-screen app.': 'um Forge Fitness Server als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if Forge Fitness Server is closed.': 'Pausen-Timer-Alarm, auch wenn Forge Fitness Server geschlossen ist.',
