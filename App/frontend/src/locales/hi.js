export default {
  ...
  "This browser doesn't support passkeys — you can still use ForgeFitServer locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर ForgeFitServer लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install ForgeFitServer as a full-screen app.': 'से ForgeFitServer को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': 'आराम टाइमर अलर्ट, ForgeFitServer बंद होने पर भी।',
