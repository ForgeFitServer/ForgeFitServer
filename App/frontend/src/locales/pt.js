...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": 'Este navegador não suporta passkeys — ainda assim podes usar o Forge Fitness Server localmente neste dispositivo.',
  ...
  'to install ForgeFitServer as a full-screen app.': 'para instalar o ForgeFitServer como app em ecrã inteiro.',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': 'Alertas do temporizador de descanso, mesmo com o ForgeFitServer fechado.',
