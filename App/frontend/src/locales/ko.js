export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": '이 브라우져는 패스키를 지원하지 않아요 — 그래도 이 기기에서 Forge Fitness Server을 로컬로 사용할 수 있습니다.',
  ...
  'to install ForgeFitServer as a full-screen app.': '하면 ForgeFitServer을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': 'ForgeFitServer이 닫혀 있어도 휘식 타이머 알림을 받아요.',
