export default {
  ...
  "This browser doesn't support passkeys — you can still use Forge Fitness Server locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Forge Fitness Server можно использовать локально на этом устройстве.',
  ...
  'to install ForgeFitServer as a full-screen app.': 'чтобы установить ForgeFitServer как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if ForgeFitServer is closed.': 'Оповещения таймера отдыха, даже если ForgeFitServer закрыт.',
