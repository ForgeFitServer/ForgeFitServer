...
/**
 * Parse CSV with quoted fields, embedded commas/newlines, doubled quotes, BOM, CRLF
 */
...
/**
 * Read an export into workouts Forge Fitness Server understands, WITHOUT touching state — the caller
